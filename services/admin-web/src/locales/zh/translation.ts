...
export default {
  ...
  curriculum: {
    ...
    curriculumName: "大纲名称",
    enterCurriculumNameWithLimit: " 请输入大纲名称，限 100 个汉字",
    curriculumDescription: "大纲描述",
    enterCurriculumDescriptionWithLimit: "请输入大纲描述，限 1000 个汉字",
    sessions: "课堂列表",
    pleaseNote: "请注意",
    ...
    startApplicableDays: "适用起始天数",
    applicableDays: "适用天数",
    endApplicableDays: "适用结束天数",
    to: "至",
    ...
    curriculumNameTooLong: "大纲名称最多100个字符",
    curriculumDescriptionTooLong: "大纲描述最多1000个字符",
  ...
  form: {
    ...
    areasSizeInvalid: "最多只能添加3个区域",
    areaLengthInvalid: "地区不能超过100个字",
  },
  antd: {
    local: zhCN,
  },
